...
final class KeychainSessionStoreTests: XCTestCase {
    ...
    private let store = KeychainSessionStore(service: "me.byjp.kimbia-sync.tests.\(UUID().uuidString)", accessGroup: nil)
    ...
    func testStoresAreIsolatedByService() throws {
        let other = KeychainSessionStore(service: "me.byjp.kimbia-sync.tests.other.\(UUID().uuidString)", accessGroup: nil)
